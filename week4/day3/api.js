...
//         const className = pokemon.pokemon[0].sprites.front
...
// image() =
//         for (const pokemon of data) {
//        console.log(pokemon.pokemon[3][0])}};
// "https://assets.pokemon.com/assets/cms2/img/pokedex/full/025.png"

function fetchPokemonData(){
    const cardContainer = document.querySelector(".card-container");
    const pokemonData = data[0].pokemon;
    for (const pokes of pokemonData) {
        const cards = document.createElement("div");
      cards.className = "cards";
      const cardImg = document.createElement("img");
      cardImg.src = pokes.sprites.front
      const cardName = document.createElement("h4");
      cardName.innerHTML = pokes.name;
